          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-lg-4 text-center px3">
                <img src="<?= $main_url ?>assets/image/default-barang.jpg" class="profile-user-img img-circle mb-3" alt="User">
                <input type="file" name="image" class="form-control">
                <span class="text-sm">Type file gambar JPG | JPG | GIF</span><br>
